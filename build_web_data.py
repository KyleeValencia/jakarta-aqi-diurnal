...
DISCLAIMERS = [
    ...
    "pengukuran langsung.",
    "Nilai simulasi dihitung per sel hex H3 pada grid daratan DKI dan ditampilkan sebagai pola "
    "harian penuh pada slot jam tetap.",
    "Bentuk kurva dalam satu hari berasal dari CAMS dan dikalibrasi ke ISPU pada puncak harian. "
    "Tidak ada data lapangan per jam, sehingga kurva sub-harian tidak bisa dicek secara terpisah.",
    "Data lapangan hanya berasal dari 5 stasiun pemantau DKI, sehingga akurasi di luar stasiun "
    "(per sel) TIDAK bisa dicek secara terpisah. Perbedaan antar sel adalah gradasi tampilan "
    "berbasis model, bukan nilai hasil pengukuran. Penerapan nyata wajib menyatakan hal ini.",
]
